...
once the specified time (uploadInterval) has passed since the last upload - the only
upload trigger implemented (a size-based one was planned but never built).
